...
public class AuthService {
        ...
        public AuthenticationResponse register(RegisterRequest request) {
                ...
                String verificationLink = "http://127.0.0.1:52552/#/verify-email?token=" + user.getVerificationToken();
                emailService.sendEmail(user.getEmail(), "Vérifiez votre email",
                                "<h1>Bienvenue !</h1><p>Cliquez <a href='" + verificationLink
                                                + "'>ici</a> pour vérifier votre compte.</p>");
        ...
        public void forgotPassword(ForgotPasswordRequest request) {
                ...
                if (user != null) {
                        ...
                        String resetLink = "http://127.0.0.1:52552/#/reset-password?token=" + token;
        ...
        public void resendVerificationEmail(String email) {
                ...
                // Send email
                String verificationLink = "http://127.0.0.1:52552/#/verify-email?token=" + newToken;
                emailService.sendEmail(user.getEmail(), "Verify your email",
                                "<h1>Email Verification</h1><p>Click <a href='" + verificationLink
