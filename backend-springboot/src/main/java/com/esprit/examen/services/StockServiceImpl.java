...
public class StockServiceImpl implements IStockService {
    ...
    @Override
    public int getQteTotale(Long idStock) {
        Stock stock = retrieveStock(idStock);
        return stock.getProduits().stream().mapToInt(p -> produitService.getQuantiteProduit(p.getIdProduit())).sum();
    }
    ...
    public String retrieveStatusStock() {
        ...
        List<Stock> stocksEnRouge = retrieveAllStocks().stream()
