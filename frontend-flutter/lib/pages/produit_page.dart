            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (code.isEmpty || libelle.isEmpty || selectedCategorieId == null) {
                    _showSnackBar(
                  ...
                  final newProduit = Produit(
                    ...
                    idStock: isEdit
                        ? (selectedStockId ?? produit!.idStock)
                        : selectedStockId,
                  );
                  ...
                  try {
                    ...
                    // 📤 Upload image si sélectionnée (MODIFICATION SEULEMENT)
                    ...
                    if (!isEdit && selectedStockId != null) {
                      await service.assignProduitToStock(
                        ...
                        selectedStockId != originalStockId &&
                    ...
                    if (mounted) {
                      ...
                      Future.microtask(() => _refreshProduits());
                    }
                  } catch (e) {
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          if (p.idStock != null)
                            Text(
                              p.libelleStock != null
                                  ? "Stock: ${p.libelleStock} (${p.stockQte})"
                                  : "Stock affecté (${p.stockQte})",
                      ...
                      Text(
                        "Dernière modification : ${p.dateDerniereModification ?? "-"}",
                        style: const TextStyle(fontSize: 12),
                      ),
                    ],
                  ),
