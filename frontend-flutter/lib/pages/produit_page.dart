...
class _ProduitsPageState extends State<ProduitsPage> {
  ...
  void _showSnackBar(String message, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.red.shade600 : const Color(
            0xFF0074D9),
  ...
  void _showProduitDialog({Produit? produit}) {
    ...
    final libelleCtrl = TextEditingController(
        text: produit?.libelleProduit ?? '');
    final prixCtrl = TextEditingController(
        text: produit?.prix.toString() ?? '');
    showDialog(
      context: context,
      builder: (context) =>
          AlertDialog(
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (code.isEmpty || libelle.isEmpty) {
                    _showSnackBar(
                        "Code et libellé sont obligatoires", isError: true);
                    return;
                  }
                  ...
                  try {
                    ...
                    if (selectedStockId != null) {
                      await service.assignProduitToStock(
                          result.idProduit!, selectedStockId!);
                    }
